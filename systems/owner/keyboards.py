...
def main_menu_keyboard() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [InlineKeyboardButton(text="🔔 التفاعل التلقائي", callback_data="owner:engagement")],
            [InlineKeyboardButton(text="💸 التحويل", callback_data="owner:transfer")],
            [InlineKeyboardButton(text="🎁 مكافأة/خصم جماعي", callback_data="owner:bulk_action")],
