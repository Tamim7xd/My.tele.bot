...
def system_words_text(words: list[str]) -> str:
    if not words:
        return "⚙️ <b>خيارات النظام</b>\n━━━━━━━━━━━━━━━\nلا يوجد كلمات مضافة حالياً.\nهذه قائمة منفصلة عن الكلمات المحظورة العادية، تفحص بنفس قوة محرك التطبيع."

    return f"⚙️ <b>خيارات النظام</b> ({len(words)})\n━━━━━━━━━━━━━━━\nاضغط 🗑️ للحذف، أو ➕ للإضافة:"


ADD_SYSTEM_WORD_PROMPT = "✏️ أرسل الكلمة/اللفظ المراد إضافته لخيارات النظام."

ADD_SYSTEM_WORD_DUPLICATE = "❌ هذه الكلمة موجودة بالفعل في القائمة."


def system_word_added_text(word: str) -> str:
    return f"✅ تمت إضافة \"{word}\" لخيارات النظام."


def system_word_removed_text(word: str) -> str:
    return f"🗑️ تم حذف \"{word}\" من خيارات النظام."
